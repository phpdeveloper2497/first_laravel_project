                    ...
                    <div class="panel-body p-3">
                        <form action="{{ route('authenticate') }}" method="POST">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field"> <span class="far fa-user p-2"></span> <input name="email" type="text" placeholder="Enter your Email" required> </div>
                            </div>
                            ...
                            <div class="form-inline">
                                <input type="checkbox" name="remember" id="remember"> <label for="remember" class="text-muted">Remember me</label>
                            ...
                            <div class="text-center pt-4 text-muted">Don't have an account? <a href="{{ route('sign') }}">Sign up</a> </div>
                        </form>
                    </div>
