            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        @canany(['update','delete'], $post)
                            <div class="row mb-4">
                                ...
                                <form action="{{ route('posts.destroy',['post'=>$post->id])}}"
                                      onsubmit="return confirm('Are you sure wish to delete')"
                                      method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @foreach($post->comments as $comment)
                        ...
                        <div class="bg-light rounded p-5">
                            ...
                            @else
                                <div>
                                    <a class="btn btn-primary" href="{{ route('login') }}">Click</a> to leave a comment
                                    {{--                                    <form action="{{ route('usercomment') }}" method="POST">--}}
                                    {{--                                        @csrf--}}
                                    {{--                                    <button class="btn btn-primary" >Click</button> to leave a comment--}}
                                    {{--                                    </form>--}}
                                </div>
                            @endauth
                        </div>
                ...
                <div class="col-lg-4 mt-5  mt-lg-0">
                    <div class="d-flex flex-column text-center bg-secondary rounded mb-5 py-5 px-4">
                        <img src="/img/user.jpg {{--{{$post->user->photo}}--}}"
                    ...
                    <div class="mb-5">
                        ...
                        <div>
                            ...
                            Aliquyam sed lorem stet diam dolor sed ut sit. Ut sanctus erat ea est aliquyam dolor et. Et
                            no
                            consetetur eos labore ea erat voluptua et. Et aliquyam dolore sed erat. Magna sanctus sed
                            eos
                            tempor
